...
class Interceptor extends \Magento\Config\Model\Config implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function extendConfig($path, $full = true, $oldConfig = [])
    {
        ...
        return $pluginInfo ? $this->___callPlugins('extendConfig', func_get_args(), $pluginInfo) : parent::extendConfig($path, $full, $oldConfig);
    }
    ...
    public function setDataByPath($path, $value)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setDataByPath', func_get_args(), $pluginInfo) : parent::setDataByPath($path, $value);
    }
    ...
    public function getConfigDataValue($path, &$inherit = null, $configData = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getConfigDataValue', func_get_args(), $pluginInfo) : parent::getConfigDataValue($path, $inherit, $configData);
    }
