...
class Interceptor extends \Mgt\Varnish\Model\ResourceModel\Url\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addTagsFilter');
        return $pluginInfo ? $this->___callPlugins('addTagsFilter', func_get_args(), $pluginInfo) : parent::addTagsFilter($tags);
    }
